...
Create a worksheet named `ClassificationRules` (or customize via `GOOGLE_CLASSIFICATION_WORKSHEET_NAME` setting) to automatically categorize transactions. This allows Finmail to intelligently assign categories to transactions based on patterns you define.
